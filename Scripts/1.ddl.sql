...
create table mybatis_study.students ( stud_id int(11) not null auto_increment comment '학생코드',
	...
	primary key (stud_id),
	constraint fk_students_addr foreign key (addr_id) references mybatis_study.addresses (addr_id) ) comment '학생';
